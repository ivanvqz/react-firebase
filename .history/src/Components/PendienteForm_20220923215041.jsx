        ...
        <div>
            ...
            >
                <label className="flex flex-col mx-10">
                    ...
                    <select
                        id="priority"
                        className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:online-none focus:border-purple-500"
                    >
