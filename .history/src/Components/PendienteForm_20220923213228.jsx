            ...
            >
                ...
                <label className="flex flex-row">
                    ...
                    <input 
                        type="text" 
                        id="description" 
                        className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:online-none focus:bg-white focus:border"
                    />
                </label>
